...
(function(a){
    ...
    o=o.split(",");
    for(var r=0,s=o.length;r<s;r++)a("head",c).append('<link href="'+m+"skins/"+o[r]+'.css" rel="stylesheet" type="text/css"/>');
    a.fn.fixie6png=function(){
        var b=a("*",this),c,d;
        for(var e=0,f=b.length;e<f;e++)c=a(b[e]).css("ie6png"),d=m+"skins/"+c,c&&(b[e].style.backgroundImage="none",b[e].runtimeStyle.filter="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='"+d+"',sizingMethod='scale')")
    },a.fn.dialog=function(b){
        var c=!1;
        this[0]&&(c=new a.dialog(b),this.bind("click",c.ShowDialog));
        return c
    },a.dialog=function(l){
        var m=this,n,q,r,s,t,u,v,w,x,y=a.extend({
            title:"",
            cover:!1,
            titleBar:!0,
            btnBar:!0,
            ...
            y.lockScroll&&a("html",c).addClass("lhgdg_lockScroll"),a(b).bind("resize",p),p(),a(d).css({
                display:"",
                zIndex:i()
            })
        },G=function(b,c,d,e){
            ...
            if(y.html)e=Math.max(q.scrollHeight,q.clientHeight||0),f=Math.max(q.scrollWidth,q.clientWidth||0);
            ...
            function p(d){
                for(var e=0,g=i.length;e<g;e++)a(i[e].document).unbind("mousemove",o),a(i[e].document).unbind("mouseup",p);
            ...
            function o(a){
                ...
                h={
                    x:h.x+(b.x-c.x),
                    y:h.y+(b.y-c.y)
                },c=b,y.rang&&(h.x<n.x&&(h.x=n.x),h.y<n.y&&(h.y=n.y),h.x>d&&(h.x=d),h.y>g&&(h.y=g)),m.dg.style.top=y.fixed&&!f?h.y-n.y+"px":h.y+"px",m.dg.style.left=y.fixed&&!f?h.x-n.x+"px":h.x+"px"
            }
            var c,d,g,h,i=w,l,n;
            a(b).bind("mousedown",function(b){
                if(b.target.id!=="lhgdg_xbtn_"+y.id){
                    ...
                    h=y.fixed&&!f?{
                        ...
                        x:b.screenX,
                        y:b.screenY
                    },d=l.w+n.x-s,g=l.h+n.y-t,m.dg.style.zIndex=parseInt(e,10)+1;
                    for(var u=0,v=i.length;u<v;u++)a(i[u].document).bind("mousemove",o),a(i[u].document).bind("mouseup",p);
                    b.preventDefault(),a.browser.msie&&m.dg.setCapture()
                }
            })
        },M=function(b){
            function p(d){
                for(var e=0,f=h.length;e<f;e++)a(h[e].document).unbind("mousemove",o),a(h[e].document).unbind("mouseup",p);
            ...
            function o(a){
                ...
                i={
                    w:b.x-c.x,
                    h:b.y-c.y
                },i.w<200&&(i.w=200),i.h<100&&(i.h=100),m.dg.style.top=y.fixed?g.y-n.y+"px":g.y+"px",m.dg.style.left=y.fixed?g.x-n.x+"px":g.x+"px",m.reDialogSize(i.w,i.h)
            }
            var c,d,f,g,h=w,i,l,n;
            a(b).bind("mousedown",function(b){
                f=m.dg.clientWidth,d=m.dg.clientHeight,i={
                    w:f,
                    h:d
                },l=k(),n=j();
                ...
                for(var s=0,t=h.length;s<t;s++)a(h[s].document).bind("mousemove",o),a(h[s].document).bind("mouseup",p);
                b.preventDefault(),a.browser.msie&&m.dg.setCapture()
            })
        },N=function(a){
        ...
        m.ShowDialog=function(){
            ...
            var b,c;
            b=k(),c=j(),B?(m.reDialogSize(A.dgW,A.dgH),a(m.dg).css({
                top:A.dgT,
                left:A.dgL
            ...
            if(y.btnBar)if(a("#lhgdg_"+y.id+"_"+b,c)[0])a("#lhgdg_"+y.id+"_"+b,c).html("<em>"+d+"</em>").unbind("click").bind("click",e);
                    ...
                    var g='<a id="lhgdg_'+y.id+"_"+b+'" class="lhgdg_button_'+y.skin+'" href="javascript:void(0);" target="_self"><em>'+d+"</em></a>",h=a(g,c).bind("click",e)[0];
